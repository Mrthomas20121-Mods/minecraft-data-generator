...
export class MetallumModelManager extends ModelManager {
    ...
    ore(blockName, texture1, texture2) {
    ...
    bars(metal) {
        ...
        let itemPath = this.createTagPath(join('.', 'generated', this.modid, 'assets', this.modid, 'models', 'item', this.joinString(blockName, '.json')));
        this.save(fullBlockstatePath, {
            "multipart": [
                {
                    "apply": {
